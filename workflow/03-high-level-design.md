...
**Ровно 3 строки** — pillar ID + направление. На шаге 4 обычно раскрывают **1–2**, не все три. Implementation → §4.

| Роль | Секция | Вопрос |
|------|--------|--------|
| START | §2.8 | С чего **начать** Deep Dive? |
| AGENDA | §3.4 | Какие pillars **держать в голове** (0–1 блок кроме START) |
...
Примеры: [instagram §3](../examples/instagram-feed.md#3-hld) · [paypal §3](../examples/paypal-payments.md#3-hld) · [vk §3](../examples/vk-social.md#3-hld) · [open-world §3](../examples/open-world-mobile-game.md#3-hld)
